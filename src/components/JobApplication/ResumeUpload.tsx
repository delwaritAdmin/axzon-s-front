    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <div className="border border-[#797979] rounded-[6px] p-3 sm:p-4 space-y-3 sm:space-y-4">
          ...
          <div className={`border-2 border-dashed rounded-[6px] p-3 sm:p-4 text-center ${errors.resume || resumeError ? 'border-red-500' : 'border-[#7E22CE]'}`}>
            <Input
              type="file"
        ...
        <div className="border border-[#797979] rounded-[6px] p-3 sm:p-4 space-y-3 sm:space-y-4">
          <h4 className="text-lg sm:text-xl font-bold">Cover Letter (Optional)</h4>
          <p className="text-sm sm:text-base">
          ...
          {/* Remove the error message for cover letter */}
        </div>
      </div>
    </div>
  );
